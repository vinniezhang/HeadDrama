...
var timeOutInterval = 92500;
var startTime;
var yesClick = false;

function preload(){
	storyLines = loadStrings('text/rainforest.txt');
	song = loadSound('aud/adventure.mp3');
}
...
function draw() {
	...
	if(clicked == true){
		background(color(2, 142, 30));
		fill(color(237, 169, 2));
		textSize(170);
		textFont("Poppins");
