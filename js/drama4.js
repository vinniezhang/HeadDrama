...
function preload(){
	storyLines = loadStrings('text/toilet.txt');
	song = loadSound('aud/funny.mp3');
}
...
function draw() {
	...
	if (clicked == true){
		background(color(232, 255, 33));
		fill(color(135, 111, 52));
		textSize(170);
		textFont("Poppins");
